...
$email = (new TemplatedEmail())
                ->from('newsletteraloui@gmail.com')
                ->to($user->getEmail())
            ...
            $this->addFlash('message', 'Un email vous a été envoyer pour valider votre inscription');
...
public function confirm(Users $user, $token):Response{
    ...
    $this->addFlash('message', 'Merci pour votre inscription a notre Newsletter , maintenant  vous etes abonnés');
...
/**
 ...
 /**
    ...
    public function send( Newsletters $newsletter, MailerInterface $mailer): Response
    {
        ...
        $this->addFlash('message', 'Newsletter a été envoyé!');
    ...
    public function unsubscribe(Users $user, Newsletters $newsletter, $token): Response
    {
        ...
        $this->addFlash('message', 'Maintenant vous etes desabonnées de Newsletter :(');
